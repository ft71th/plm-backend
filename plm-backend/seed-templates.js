  ...
  // ── ARCHITECTURE ──────────────────────────────────────────
  {
    ...
    schema: {
      ...
      sections: [
        ...
        { id: 'seq_diagram', title: '6. Sequence Diagrams', type: 'sequence_embed' },
        { id: 'design_decisions', title: '7. Design Decisions', type: 'static', template_content: '<p>Document key architectural decisions and their rationale.</p>' },
        { id: 'refs', title: '8. References', type: 'reference_list' },
        { id: 'approval', title: '9. Approval', type: 'signature_block', signatories: [
          { role: 'Author', required: true },
  ...
  // ── ALARM LIST ────────────────────────────────────────────
  {
    ...
    schema: {
      ...
      sections: [
        ...
        { id: 'auto_alarms', title: '2. Auto-Derived Alarms (from PLM)', type: 'alarm_list' },
        { id: 'alarms', title: '3. Alarm List', type: 'manual_table', columns: [
        ...
        { id: 'approval', title: '4. Approval', type: 'signature_block', signatories: [
          { role: 'Author', required: true },
          { role: 'Technical Reviewer', required: true },
        ]},
      ],
